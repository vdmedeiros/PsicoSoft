...
namespace PsicoSoft.Pacientes.API.Data
{
    public class PacienteContext : DbContext, IUnitOfWork
    {
        private readonly IMediatorHandler _mediatorHandler;
        public PacienteContext(DbContextOptions<PacienteContext> options, IMediatorHandler mediatorHandler) : base(options) {
            _mediatorHandler = mediatorHandler;
            ChangeTracker.QueryTrackingBehavior = QueryTrackingBehavior.NoTracking;
            ChangeTracker.AutoDetectChangesEnabled = false;
        }

        public DbSet<PsicoSoft.Pacientes.API.Models.Paciente> Pacientes { get; set; }
